...
class OpenApiConfigEspecialidadesTest {

    @Test
    void deveCriarBeanOpenAPIComInformacoesEsperadas() {
        OpenApiConfigEspecialidades config = new OpenApiConfigEspecialidades();
        OpenAPI openAPI = config.customOpenAPIEspecialidades();

        Info info = openAPI.getInfo();
        assertNotNull(info);
        assertEquals("Especialidades-API", info.getTitle());
