...
public class SecurityConfigurationAgendamentos implements WebMvcConfigurer {

    private final SecurityFilterAgendamentos securityFilter;
    ...
    @Bean
    public AuthenticationManager authenticationManagerAgendamentos(AuthenticationConfiguration authenticationConfiguration) throws Exception {
        return authenticationConfiguration.getAuthenticationManager();
    }

    @Bean
    public PasswordEncoder passwordEncoderAgendamentos(){
